...
4. To interact with the main CLI application
python3 main.py
...
**IMPORTANT: To prevent frequent crashing, please be aware that a lot of inputs are case-sensitive so when provided how to input, type exactly as it is. Assume capitalization as a rule of thumb.**  
